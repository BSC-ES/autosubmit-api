...
#
#BSUB -q sequential
#BSUB -J t0ni_19931101_fc0_1_MONITOR
#BSUB -oo /gpfs/scratch/bsc32/bsc32627/t0ni/LOG_t0ni/t0ni_19931101_fc0_1_MONITOR.cmd.out
#BSUB -eo /gpfs/scratch/bsc32/bsc32627/t0ni/LOG_t0ni/t0ni_19931101_fc0_1_MONITOR.cmd.err
#BSUB -W 01:00
#BSUB -n 4
...
job_name_ptrn = '/gpfs/scratch/bsc32/bsc32627/t0ni/LOG_t0ni/t0ni_19931101_fc0_1_MONITOR'
    ...
    def run(self):
        ...
        for domain in 'OCEAN ATMOS'.lower().split(' '):
            ...
            recipe = os.path.join(self.scratch_dir,
                                  f"recipe_t0ni_19931101_fc0_1_MONITOR_{domain}.yml".lower())
