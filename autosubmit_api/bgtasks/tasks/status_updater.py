...
class StatusUpdater(BackgroundTaskTemplate):
    ...
    def _get_mutable_statuses(
        cls, experiment_statuses: list[ExperimentStatusModel] | None = None
    ...
    @classmethod
    def _check_exp_running(cls, expid: str, status_row: ExperimentStatusModel | None = None) -> bool:
        """
    ...
    def _update_experiment_status(
        ...
        is_running: bool,
        status_row: ExperimentStatusModel | None = None,
    ):
        """
        Update experiment status using guarded conditional update.

        Guard against overwriting ARCHIVED/DELETED/NOT RUNNING status.
        """
        status_repository = create_experiment_status_repository()
